  ...
  try {
    ...
    const result = await prisma.$transaction(
      async (tx: Prisma.TransactionClient) => {
        ...
        const updatePromises = reorderedCells
          .map((cell: { id: string; position: number }, index: number) => {
